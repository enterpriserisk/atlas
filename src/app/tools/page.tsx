...
export const metadata: Metadata = {
  ...
  description:
    "Reference cards for AI tools available to U-M Enterprise Strategic Risk Management staff: what each is approved for, data-sensitivity notes, strengths, and limitations.",
};
