...
/**
 * DraftTag — visible "Draft — pending ESRM review" flag for placeholder content that
 ...
 */
export function DraftTag({ className, label = "Draft — pending ESRM review" }: { className?: string; label?: string }) {
  return (
    <span
      className={cn(
